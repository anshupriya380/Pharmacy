...
<div class="content">
            <table class="tb">
                <tr>
                    ...
                    <td>
                    	<img src="images/payment.png" height="200" alt="edit" />
                    </td>
                </tr>
                <tr>
                	<td align="center">
                		<a href="cashier.php" class="link">
                	
                		<span>Dashboard</span>
                		</a>
                	</td>
                	<td align="center">
                		<a href="payment.php"target="_top" class="link">
    ...
    <div style="background-color: #231F20; font-size: 17px;padding: 6px; margin-top: 298px">
