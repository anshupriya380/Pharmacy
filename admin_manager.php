...
<div class="content" style="margin-left:235px;width: 700px;">
		    ...
		    <h2 style="padding-bottom: 0px;margin-bottom: 0px;margin-top: 0px">Manage Manager</h2> 
			<hr style="background-color: black;width: 100%;height: 3px;" align="left">	
			</div>
		    <div style="margin-top: 15px;">   
		        <a href="javascript:tabSwitch('tab_1', 'content_1');" id="tab_1" class="active" style="text-decoration: none"><button class="btn">VIEW MANAGER</button></a>
		        <a href="javascript:tabSwitch('tab_2', 'content_2');" id="tab_2" style="text-decoration: none"><button class="btn">ADD MANAGER</button></a>
		    </div>
