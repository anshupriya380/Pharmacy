...
<div style="width: 100%;display: flex;">
		...
		<div class="content" style="margin-left:235px;width: 700px;">
		    ...
		    <h2 style="padding-bottom: 0px;margin-bottom: 0px;margin-top: 0px">Manage Pharmacist</h2> 
			<hr style="background-color: black;width: 100%;height: 3px;" align="left">	
			</div>
		    <div style="margin-top: 15px;">   
		        <a href="javascript:tabSwitch('tab_1', 'content_1');" id="tab_1" class="active" style="text-decoration: none"><button class="btn">VIEW PHARMACIST</button></a>
		        <a href="javascript:tabSwitch('tab_2', 'content_2');" id="tab_2" style="text-decoration: none"><button class="btn">ADD PHARMACIST</button></a>
		    </div>
		    ...
		    $result = mysqli_query($conn, "SELECT * FROM pharmacist")or die(mysql_error());
		        ...
		        while($row = mysqli_fetch_array( $result )) {
						...
						<td style="width: 20px"><a href="update_pharmacist.php?id=<?php echo $row['pharmacist_id']?>"><img src="images/update-icon.png" width="35" height="35" border="0" /></a></td>
						<td style="width: 20px"><a href="delete_pharmacist.php?id=<?php echo $row['pharmacist_id']?>"><img src="images/delete-icon.jpg" width="35" height="35" border="0" /></a></td>
						</tr>
						<?php
				 } 
				 ?>
